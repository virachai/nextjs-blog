...
export default function TopNavbar() {
  ...
  return (
    <nav className={`${styles.navs} navbar navbar-expand-sm`}>
      <div className={`${styles.nav_mobile} sm:hidden min-w-[160px]`}>
        <button
      ...
      <div className="hidden md:block md:px-3 lg:px-6 w-1/4">
      ...
      <div id="navbarIconMenu" className="hidden flex-row justify-end md:flex">
        <Link className="" href="#">
